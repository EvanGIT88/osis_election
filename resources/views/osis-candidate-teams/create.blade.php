...
@section('content')
    ...
    <div class="page-body">
                            ...
                            @endif
        <div class="container-xl">
            <form class="card card-md" action="/osis-candidate-teams/create" method="post" autocomplete="off" >
            @csrf
                              <!--
                        protected $fillable = [
                            'user_id',
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    -->
                    <input type="text" name="vision" class="form-control @error('vision') is-invalid @enderror" placeholder="Enter vision" value="{{ old('vision') }}">
                    @error('vision')
                    ...
                    Retrieved 2026-02-09, License - CC BY-SA 3.0
                    -->
                    <input type="text" name="mission" class="form-control @error('mission') is-invalid @enderror" placeholder="Enter mission" value="{{ old('mission') }}">
                    @error('mission')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
