    ...
    'menu' => [
        // Navbar items:
            ...
            'submenu' => [
                [
                    'text' => 'Create',
                    'url' => 'users/create-page',
                    'icon' => 'ti ti-create',
                               'active' => ['users/create-page'],
                ],
                [
                    'text' => 'View',
                    'url' => 'users/index',
            ...
            'text' => 'OsCandidates',
            'icon' => 'ti ti-users',
            'active' => ['osis-candidates'],
            'submenu' => [
                [
                    'text' => 'Create',
                    'url' => 'osis-candidates/create-page',
                    'icon' => 'ti ti-create',
                               'active' => ['osis-candidates/create-page'],
                ],
                [
                    'text' => 'View',
                    'url' => 'osis-candidates/index',
                    'icon' => 'ti ti-read',
                               'active' => ['osis-candidates/index'],
                ]
            ],
        ],
                                [
            'text' => 'Candidate Team',
            'icon' => 'ti ti-users',
            'active' => ['osis-candidate-teams'],
            'submenu' => [
                [
                    'text' => 'Create',
                    'url' => 'osis-candidate-teams/create-page',
                    'icon' => 'ti ti-create',
                               'active' => ['osis-candidate-teams/create-page'],
                ],
                [
                    'text' => 'View',
                    'url' => 'osis-candidate-teams/index',
                    'icon' => 'ti ti-read',
                               'active' => ['osis-candidate-teams/index'],
                ]
            ],
        ],
                                        [
            ...
            'submenu' => [
                [
                    'text' => 'Create',
                    'url' => 'votes/create-page',
                    'icon' => 'ti ti-create',
                               'active' => ['votes/create-page'],
                ],
                [
                    'text' => 'View',
                    'url' => 'votes/index',
